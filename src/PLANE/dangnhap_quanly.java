...
public class dangnhap_quanly extends JFrame {
	...
	public dangnhap_quanly(final int n, final JMenu Mn,  final JMenu Mn1, final JMenu mndn, final JButton bt, final JButton bt_user, final JMenu dichvu) {
		...
		lb_taikhoan.setBounds(66, 132, 88, 29);
		contentPane.add(lb_taikhoan);
		
		textField_taikhoan = new JTextField();
		textField_taikhoan.setBounds(184, 136, 147, 20);
		...
		lb_matkhau.setBounds(66, 191, 88, 17);
		contentPane.add(lb_matkhau);
		
		passwordField_matkhau = new JPasswordField();
		passwordField_matkhau.setBounds(184, 188, 147, 20);
		...
		bt_dangnhap.setBounds(184, 254, 147, 23);
		...
		lb_title.setBounds(189, 81, 142, 29);
		...
		lblNewLabel_2.setBounds(50, 52, 407, 288);
